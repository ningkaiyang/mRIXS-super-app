...
Usage Examples:
    python cluster_cli.py dark-mask --dark-dir /path/to/dark --output-dir /path/to/out
    python cluster_cli.py cluster --signal-dir /path/to/signal --dark-tif /path/to/MED_Dark.tif --mask-tif /path/to/Final_Mask.tif --output-dir /path/to/out
    python cluster_cli.py reconstruct --clusters-xls /path/to/Results_clusters.xls --output-dir /path/to/out --intden-low 120 --intden-high 320
    python cluster_cli.py full --dark-dir /path/to/dark --signal-dir /path/to/signal --output-dir /path/to/out --intden-low 120 --intden-high 320
"""
...
def run_cluster(args: argparse.Namespace) -> int:
    ...
    dark_tif = Path(args.dark_tif)
    mask_tif = Path(args.mask_tif)
...
def main() -> None:
    ...
    p_dark.add_argument("--output-dir", "-o", required=True, help="Directory to save MED_Dark.tif and Final_Mask.tif")
    ...
    p_clust.add_argument("--dark-tif", required=True, help="Path to precomputed MED_Dark.tif")
    p_clust.add_argument("--mask-tif", required=True, help="Path to precomputed Final_Mask.tif")
    p_clust.add_argument("--output-dir", "-o", required=True, help="Directory to save Results_clusters.xls")
    ...
    p_recon.add_argument("--output-dir", "-o", required=True, help="Directory to save Photon_Event_Map.tif")
    ...
    p_full.add_argument("--output-dir", "-o", required=True, help="Output directory for all artifacts")
